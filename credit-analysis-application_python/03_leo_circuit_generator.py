neurons_per_layer = [20, 10, 2] # specifies NN architecture
scaling_factor = 4 # specifies scaling factor for fixed point numbers
integer_type = "i16" # specifies used integer type
...
for i in range(neurons_per_layer[0]): # input layer
   line += "let neuron0"+str(i) + ": " + integer_type + " = input" + str(i) + " / " + str(2**scaling_factor) + ";\n"
